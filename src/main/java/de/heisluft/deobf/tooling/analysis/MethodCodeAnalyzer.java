...
public class MethodCodeAnalyzer extends MethodVisitor {
    ...
    public MethodCodeAnalyzer(String className, JDKClassProvider provider) {
      super(ASM7);
    ...
    private static String desc(String type) {
